...
flags.DEFINE_string(
    "output_dir", '/data/nfsdata/home/wuwei/study/bert/squad',
    "The output directory where the model checkpoints will be written.")

## Other parameters
flags.DEFINE_string("train_file", '/data/nfsdata/nlp/datasets/reading_comprehension/squad/train-v1.1.json',
                    "SQuAD json for training. E.g., train-v1.1.json")

flags.DEFINE_string(
    "predict_file", '/data/nfsdata/nlp/datasets/reading_comprehension/squad/dev-v1.1.json',
