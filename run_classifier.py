...
#  Required parameters
flags.DEFINE_string(
    "data_dir", '/data/nfsdata/nlp/datasets/glue_data/MRPC',
...
flags.DEFINE_string("output_dir", '/data/nfsdata/home/wuwei/study/bert',
...
def main(_):
    ...
    if FLAGS.do_train:
        ...
        estimator.export_savedmodel('export_dir/1', export_input_fn)
